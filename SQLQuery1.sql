...
(
	[UserId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON)
GO
SET ANSI_PADDING ON
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Farklý üye numarasý girin.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Members', @level2type=N'CONSTRAINT',@level2name=N'Unq_Member_MemberNumber'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Farklý telefon numarasý girin.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Members', @level2type=N'CONSTRAINT',@level2name=N'Unq_Member_PhoneNumber'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Ayný kullanýcý sadece bir kez üye olabilir.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Members', @level2type=N'CONSTRAINT',@level2name=N'Unq_Members_UserId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Farklý email girin.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Users', @level2type=N'CONSTRAINT',@level2name=N'Unq_User_Email'
GO
